...
The Ruby SDK for the OpenLibrarySearch API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.OpenLibrarySearch(nil).load(
  { "id" => "test01" }, nil
)
