...
class AuthorEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set OPENLIBRARYSEARCH_TEST_AUTHOR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def author_basic_setup(extra)
  ...
  entid_env_raw = ENV["OPENLIBRARYSEARCH_TEST_AUTHOR_ENTID"]
