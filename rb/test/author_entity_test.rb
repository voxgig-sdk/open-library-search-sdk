...
class AuthorEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = OpenLibrarySearchSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set OPEN_LIBRARY_SEARCH_TEST_AUTHOR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def author_basic_setup(extra)
  ...
  entid_env_raw = ENV["OPEN_LIBRARY_SEARCH_TEST_AUTHOR_ENTID"]
