...
#      offline in seeded test mode (OpenLibrarySearchSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OpenLibrarySearch_sdk.rb")
  SDK_CLASS = "OpenLibrarySearchSDK"
  ...
  SDK_BASE = "OpenLibrarySearch_sdk"
