...
Results: Successful author search response.
...
| --- | --- | --- | --- |
| Author | `list` | `GET /search/authors.json` | See reference |
| Search | `list` | `GET /search.json` | See reference |

## Connect to the API

- Production server: `https://openlibrary.org`
...
- `open-library-search_list`: List records for an entity. Supported entities: `author`, `search`.
- `open-library-search_load`: Load one record for an entity. No active entity supports this operation.
