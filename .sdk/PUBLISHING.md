...
|---|---|---|
| `ts/` | @voxgig-sdk/open-library-search-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/open-library-search-sdk \
      --repository voxgig-sdk/open-library-search-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/open-library-search-sdk` shows it, and
`npm trust revoke @voxgig-sdk/open-library-search-sdk --id=<id>` removes it.
