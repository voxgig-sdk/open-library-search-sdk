...
// OpenLibrarySearch SDK utility type

class OpenLibrarySearchUtility
{
    ...
    public static function copy(OpenLibrarySearchUtility $src): OpenLibrarySearchUtility
    {
        $u = new OpenLibrarySearchUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
