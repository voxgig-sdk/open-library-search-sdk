...
// OpenLibrarySearch SDK utility: fetcher

class OpenLibrarySearchFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenLibrarySearchSDK/1.0)';
    ...
    public static function call(OpenLibrarySearchContext $ctx, string $fullurl, array $fetchdef): array
    {
