...
// OpenLibrarySearch SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OpenLibrarySearchTransformResponse
{
    public static function call(OpenLibrarySearchContext $ctx): mixed
    {
        ...
        $transform = OpenLibrarySearchHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
