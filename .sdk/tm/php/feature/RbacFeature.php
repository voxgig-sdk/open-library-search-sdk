...
// OpenLibrarySearch SDK rbac feature
...
class OpenLibrarySearchRbacFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _required(OpenLibrarySearchContext $ctx): ?string
    {
    ...
    private function _reject(OpenLibrarySearchContext $ctx, string $required): void
    {
    ...
    private function _track(OpenLibrarySearchContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
