...
// OpenLibrarySearch SDK metrics feature
...
class OpenLibrarySearchMetricsFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _record(OpenLibrarySearchContext $ctx, bool $ok): void
    {
