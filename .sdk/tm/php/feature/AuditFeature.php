...
// OpenLibrarySearch SDK audit feature
...
class OpenLibrarySearchAuditFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _emit(OpenLibrarySearchContext $ctx, string $outcome): void
    {
