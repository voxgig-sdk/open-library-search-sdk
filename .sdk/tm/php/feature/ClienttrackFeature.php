...
// OpenLibrarySearch SDK clienttrack feature
...
class OpenLibrarySearchClienttrackFeature extends OpenLibrarySearchBaseFeature
{
    ...
    public function PostConstruct(OpenLibrarySearchContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenLibrarySearch-SDK';
