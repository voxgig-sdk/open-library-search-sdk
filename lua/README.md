...
The Lua SDK for the OpenLibrarySearch API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:OpenLibrarySearch(nil):load(
  { id = "test01" }, nil
)
