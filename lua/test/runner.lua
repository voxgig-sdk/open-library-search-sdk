...
function runner.env_override(m)
  local live = runner.getenv("OPEN_LIBRARY_SEARCH_TEST_LIVE")
  local override = runner.getenv("OPEN_LIBRARY_SEARCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPEN_LIBRARY_SEARCH_TEST_EXPLAIN")
