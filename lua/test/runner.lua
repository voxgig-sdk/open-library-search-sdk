...
function runner.env_override(m)
  local live = runner.getenv("OPENLIBRARYSEARCH_TEST_LIVE")
  local override = runner.getenv("OPENLIBRARYSEARCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENLIBRARYSEARCH_TEST_EXPLAIN")
