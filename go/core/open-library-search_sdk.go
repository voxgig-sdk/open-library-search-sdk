...
type OpenLibrarySearchSDK struct {
	Mode     string
...
func (sdk *OpenLibrarySearchSDK) OptionsMap() map[string]any {
...
func (sdk *OpenLibrarySearchSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpenLibrarySearchSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpenLibrarySearchSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenLibrarySearchSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpenLibrarySearchSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpenLibrarySearchSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpenLibrarySearchSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpenLibrarySearchSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenLibrarySearchSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpenLibrarySearchSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpenLibrarySearchSDK {
	...
	sdk := NewOpenLibrarySearchSDK(sdkopts)
	sdk.Mode = "test"
