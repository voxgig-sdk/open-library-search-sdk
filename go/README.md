...
The Golang SDK for the OpenLibrarySearch API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/open-library-search-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/open-library-search-sdk=../path/to/github.com/voxgig-sdk/open-library-search-sdk
```
...
| `Author` | `(data map[string]any) OpenLibrarySearchEntity` | Create a Author entity instance. |
...
```
github.com/voxgig-sdk/open-library-search-sdk/
...
The root package (`github.com/voxgig-sdk/open-library-search-sdk`) re-exports everything needed
