...
// OpenLibrarySearch SDK utility: result_basic

class OpenLibrarySearchResultBasic
{
    public static function call(OpenLibrarySearchContext $ctx): ?OpenLibrarySearchResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof OpenLibrarySearchError) ? $result->err->msg : (string)$result->err;
