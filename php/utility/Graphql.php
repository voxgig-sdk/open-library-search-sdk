...
// OpenLibrarySearch SDK utility: graphql
//
...
class OpenLibrarySearchGraphql
{
    ...
    // equivalent.
    public static function body(OpenLibrarySearchContext $ctx): mixed
    {
    ...
    public static function errors(OpenLibrarySearchContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
