...
// OpenLibrarySearch SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenLibrarySearchMakeRequest
{
    public static function call(OpenLibrarySearchContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenLibrarySearchResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenLibrarySearchResponse($fetched);
        } else {
