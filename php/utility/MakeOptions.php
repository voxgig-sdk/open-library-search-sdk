...
// OpenLibrarySearch SDK utility: make_options

class OpenLibrarySearchMakeOptions
{
    ...
    public static function call(OpenLibrarySearchContext $ctx): array
    {
        ...
        //
        // `OpenLibrarySearchSchema::optspec()` is built from the model:
        ...
        $optspec = OpenLibrarySearchSchema::optspec();
