...
// OpenLibrarySearch SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenLibrarySearchSDK::test)
...
{
    private const SDK_CLASS = 'OpenLibrarySearchSDK';
    ...
    private const SDK_BASE = 'openlibrarysearch_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../openlibrarysearch_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
