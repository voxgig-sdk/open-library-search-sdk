...
class OpenLibrarySearchTestRunner
{
    ...
    {
        $live = self::getenv('OPEN_LIBRARY_SEARCH_TEST_LIVE');
        $override = self::getenv('OPEN_LIBRARY_SEARCH_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OPEN_LIBRARY_SEARCH_TEST_EXPLAIN');
...
class_alias('OpenLibrarySearchTestRunner', 'Runner');
class_alias('OpenLibrarySearchHelpers', 'Helpers');
