...
// OpenLibrarySearch SDK ratelimit feature
...
class OpenLibrarySearchRatelimitFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _acquire(OpenLibrarySearchContext $ctx): void
    {
    ...
    private function _track(OpenLibrarySearchContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
