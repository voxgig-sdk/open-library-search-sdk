...
// OpenLibrarySearch SDK debug feature
...
class OpenLibrarySearchDebugFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _finish(OpenLibrarySearchContext $ctx, bool $ok): void
    {
