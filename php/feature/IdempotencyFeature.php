...
// OpenLibrarySearch SDK idempotency feature
...
class OpenLibrarySearchIdempotencyFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _mutating(OpenLibrarySearchContext $ctx): bool
    {
