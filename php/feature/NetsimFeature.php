...
// OpenLibrarySearch SDK netsim feature
...
class OpenLibrarySearchNetsimFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _simulate(OpenLibrarySearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenLibrarySearchContext $ctx, array $applied): void
    {
        $client = $this->client;
