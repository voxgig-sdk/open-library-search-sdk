...
// OpenLibrarySearch SDK timeout feature
...
class OpenLibrarySearchTimeoutFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _with_timeout(OpenLibrarySearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenLibrarySearchContext $_ctx, float $ms): void
    {
        $client = $this->client;
