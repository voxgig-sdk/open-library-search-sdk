...
// OpenLibrarySearch SDK paging feature
...
class OpenLibrarySearchPagingFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _is_list(OpenLibrarySearchContext $ctx): bool
    {
