...
// OpenLibrarySearch SDK proxy feature
...
class OpenLibrarySearchProxyFeature extends OpenLibrarySearchBaseFeature
{
    ...
    public function init(OpenLibrarySearchContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenLibrarySearchContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
