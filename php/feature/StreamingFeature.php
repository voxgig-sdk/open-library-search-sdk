...
// OpenLibrarySearch SDK streaming feature
...
class OpenLibrarySearchStreamingFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _iterate(OpenLibrarySearchResult $result): \Generator
    {
    ...
    private function _streamable(OpenLibrarySearchContext $ctx): bool
    {
