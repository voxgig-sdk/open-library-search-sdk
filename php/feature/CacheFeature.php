...
// OpenLibrarySearch SDK cache feature
...
class OpenLibrarySearchCacheFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _through(OpenLibrarySearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
