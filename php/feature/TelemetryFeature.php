...
// OpenLibrarySearch SDK telemetry feature
...
class OpenLibrarySearchTelemetryFeature extends OpenLibrarySearchBaseFeature
{
    ...
    private function _close(OpenLibrarySearchContext $ctx, bool $ok): void
    {
