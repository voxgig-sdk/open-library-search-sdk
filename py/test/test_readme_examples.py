# OpenLibrarySearch SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenLibrarySearchSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenLibrarySearchSDK(...) and OpenLibrarySearchSDK.test(...) become
#      OpenLibrarySearchSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openlibrarysearch_sdk"
_SDK_CLASS = "OpenLibrarySearchSDK"
