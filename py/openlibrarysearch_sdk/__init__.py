...
from openlibrarysearch_sdk.utility import register

# Load features
from openlibrarysearch_sdk.feature.base_feature import OpenLibrarySearchBaseFeature
from openlibrarysearch_sdk.features import _has_feature, _make_feature
...
class OpenLibrarySearchSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = OpenLibrarySearchUtility()
        self._utility = utility

        from openlibrarysearch_sdk.config import shared_config
    ...
    def get_utility(self):
        return OpenLibrarySearchUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenLibrarySearchSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Author(self, data=None) -> "AuthorEntity":
        ...
        from openlibrarysearch_sdk.entity.author_entity import AuthorEntity
        return AuthorEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from openlibrarysearch_sdk.entity.search_entity import SearchEntity
