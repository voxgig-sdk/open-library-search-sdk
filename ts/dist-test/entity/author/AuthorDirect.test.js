...
(0, node_test_1.describe)('AuthorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OpenLibrarySearchSDK({
...
function liveScenariosActive() { return false && process.env.OPEN_LIBRARY_SEARCH_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenLibrarySearchSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['OPEN_LIBRARY_SEARCH_TEST_AUTHOR_ENTID'];
    ...
    const client = new __1.OpenLibrarySearchSDK({
        base: 'http://localhost:8080',
