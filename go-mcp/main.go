// Command OpenLibrarySearch-mcp is an MCP server exposing the OpenLibrarySearch
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OpenLibrarySearch_list  — list records of an entity
//	OpenLibrarySearch_load  — load a single record of an entity
//
