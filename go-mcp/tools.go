...
type Args struct {
	Entity string         `json:"entity" jsonschema:"author | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenLibrarySearchSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-library-search_list",
		Description: "List records from OpenLibrarySearch. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-library-search_load",
		Description: "Load a single record from OpenLibrarySearch. " +
...
func runOp(client *sdk.OpenLibrarySearchSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenLibrarySearchSDK, name string) (sdk.OpenLibrarySearchEntity, error) {
