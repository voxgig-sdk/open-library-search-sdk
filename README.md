...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/open-library-search` | `npm install @voxgig-sdk/open-library-search` |
| Python | `voxgig-sdk-open-library-search` | `pip install voxgig-sdk-open-library-search` |
| PHP | `voxgig-sdk/open-library-search` | `composer require voxgig-sdk/open-library-search` |
| Golang | `github.com/voxgig-sdk/open-library-search-sdk/go` | `go get github.com/voxgig-sdk/open-library-search-sdk/go` |
| Ruby | `voxgig-sdk-open-library-search` | `gem install voxgig-sdk-open-library-search` |
| Lua | `voxgig-sdk-open-library-search` | `luarocks install voxgig-sdk-open-library-search` |
