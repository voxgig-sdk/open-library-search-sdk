...
Open Library provides an experimental API to search for book data.

Learn more about Open Library Search API at [openlibrary.org/dev/docs/api/search](https://openlibrary.org/dev/docs/api/search).
...
const items = await client.Author().list({ q: "example" })
```
