...
func registerSDKWords(r *eng.Registry, client *sdk.OpenLibrarySearchSDK) {
...
func runOp(client *sdk.OpenLibrarySearchSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
