...
AQL-driven CLI and REPL for the OpenLibrarySearch SDK. Positional arguments are
...
```sh
go build -o open-library-search-cli ./...
```
...
./open-library-search-cli load 1 author
./open-library-search-cli load '{id:1}' author
